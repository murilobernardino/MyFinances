...
namespace MyFinances.Data.Migrations
{
    ...
    [Migration("20251127181855_AddCategoryRelationshipCreditCardExpense")]
    partial class AddCategoryRelationshipCreditCardExpense
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyFinances.Domain.Entities.AccountPayable", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyFinances.Domain.Entities.BankAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyFinances.Domain.Entities.CreditCard", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyFinances.Domain.Entities.AccountPayable", b =>
                {
                    ...
                    b.HasOne("MyFinances.Domain.Entities.Transaction", "Transaction")
                        .WithMany()
            ...
            modelBuilder.Entity("MyFinances.Domain.Entities.Category", b =>
                {
                    b.HasOne("MyFinances.Domain.Entities.Category", "ParentCategory")
            ...
            modelBuilder.Entity("MyFinances.Domain.Entities.CreditCard", b =>
                {
                    b.HasOne("MyFinances.Domain.Entities.BankAccount", "BankAccount")
